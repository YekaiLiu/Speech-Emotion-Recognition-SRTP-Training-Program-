...
//		circlePaint.setStrokeCap(Cap.ROUND);
	...
	protected void onDraw(Canvas canvas) {
		...
		drawText(canvas, "平静", 50, 180);
		drawText(canvas, "大前天", 50, 330);
		drawText(canvas, " 忧伤", 200, 220);
		drawText(canvas, " 前天", 180, 330);
		drawText(canvas, " 高兴", 370, 140);
		drawText(canvas, " 昨天", 370, 330);
		drawText(canvas, " 愤怒", 570, 170);
		drawText(canvas, "今天", 570, 330);
	}
